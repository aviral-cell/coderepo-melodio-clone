...
This backend development question evaluates Node.js, social interaction, and data integrity concepts, ideal for junior-level roles. The problem requires identifying and fixing bugs in the artist follow and rating system of a music streaming app.
