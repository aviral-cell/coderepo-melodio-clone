...
This subjective question evaluates React, data filtering, and music discovery concepts, ideal for senior-level roles. The problem requires identifying and fixing bugs in a multi-dimensional music discovery page with language, genre, and era filters in a music streaming app.
