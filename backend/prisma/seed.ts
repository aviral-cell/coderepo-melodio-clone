...
async function main() {
  ...
  // Create liked songs relationships
  const likedSongs = [
    { userId: user1.id, songId: createdSongs[0]?.id },
    { userId: user1.id, songId: createdSongs[1]?.id },
    { userId: user1.id, songId: createdSongs[2]?.id },
    { userId: user1.id, songId: createdSongs[3]?.id },
    { userId: user1.id, songId: createdSongs[4]?.id },
    { userId: user1.id, songId: createdSongs[5]?.id },
    { userId: user1.id, songId: createdSongs[6]?.id },
    { userId: user1.id, songId: createdSongs[7]?.id },
    { userId: user1.id, songId: createdSongs[8]?.id },
    { userId: user1.id, songId: createdSongs[9]?.id },
    { userId: user1.id, songId: createdSongs[10]?.id },
    { userId: user1.id, songId: createdSongs[11]?.id },
  ].filter((song) => song.songId); // Filter out any undefined songIds
  ...
  console.log(`❤️  Created ${likedSongs.length} liked songs`);
}
